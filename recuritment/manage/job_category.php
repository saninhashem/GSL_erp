...
***********************************************************************/
$page_security = 'RECURITMENT_JOB_CAT';
$path_to_root = "../..";
include($path_to_root . "/includes/session.inc");

page(_($help_context = "Job Category"));
...
$result = get_recuritment_job_categorys();
start_form();
start_table(TABLESTYLE);
$th = array(_("Job Category Name"), "", "");
table_header($th);
...
while ($myrow = db_fetch($result))
{
	...
	label_cell($myrow["job_category_name"]);
...
text_row_ex(_("Job Category Name:"), 'job_category_name', 100,100);
end_table(1);
