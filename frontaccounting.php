...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	include_once($path_to_root . '/applications/recuritment.php');
	include_once($path_to_root . '/applications/hr.php');
	...
	class front_accounting
		...
		function init()
		{
			...
			$this->add_application(new recuritment_app());
			$this->add_application(new hr_app());
